...
void main() {
	...
	if ( coord.x >= 1.0 ) {
      ...
      `,onClick:a,children:[Ot.jsx("div",{className:"flex items-center justify-center mb-4",children:Ot.jsx("div",{className:"p-4 rounded-full bg-white text-gray-800",children:n})}),Ot.jsx("h3",{className:"text-xl font-bold mb-2 text-center",children:c}),Ot.jsx("p",{className:"text-center text-sm",children:t})]}),fC=()=>{const[c,t]=vn.useState("home"),n=()=>Ot.jsxs("div",{className:"bg-gray-100 min-h-screen p-8 font-sans antialiased flex items-center justify-center",children:[Ot.jsx("h1",{className:"text-4xl sm:text-6xl font-extrabold text-blue-900 mb-8 sm:mb-12 text-center drop-shadow-md font-['Inter']",children:"日本語を学びましょう!"}),Ot.jsx("p",{className:"text-lg sm:text-xl text-gray-700 mb-10 text-center max-w-2xl font-['Inter']",children:"Choose a topic to begin your learning journey."}),Ot.jsxs("div",{className:"grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6",children:[Ot.jsx(kc,{title:"Hiragana & Katakana",description:"View and learn the two Japanese syllabaries.",icon:Ot.jsx(fS,{className:"w-12 h-12"}),onClick:()=>t("hiragana-katakana"),color:"bg-purple-100 border-purple-500 hover:bg-purple-200",shadow:"shadow-purple-201"}),Ot.jsx(kc,{title:"Kanji Flashcards",description:"Learn the readings and meanings of basic Kanji characters.",icon:Ot.jsx(uC,{className:"w-12 h-12"}),onClick:()=>t("kanji"),color:"bg-emerald-100 border-emerald-500 hover:bg-emerald-200",shadow:"shadow-emerald-200"}),Ot.jsx(kc,{title:"Vocabulary Quiz",description:"Expand your vocabulary with common Japanese words.",icon:Ot.jsx(sS,{className:"w-12 h-12"}),onClick:()=>t("vocabulary"),color:"bg-amber-100 border-amber-500 hover:bg-amber-200",shadow:"shadow-amber-200"}),Ot.jsx(kc,{title:"Pachinko Game",description:"Relax and play a fun pachinko-style game.",icon:Ot.jsx(cS,{className:"w-12 h-12"}),onClick:()=>t("pachinko"),color:"bg-indigo-100 border-indigo-500 hover:bg-indigo-200",shadow:"shadow-blue-200"})]})]}),a=()=>{switch(c){case"home":return Ot.jsx(n,{});case"hiragana-katakana":return Ot.jsx(pS,{onGoBack:()=>t("home")});case"kanji":return Ot.jsx(mS,{onGoBack:()=>t("home")});case"vocabulary":return Ot.jsx(gS,{onGoBack:()=>t("home")});case"pachinko":return Ot.jsx(cC,{onGoBack:()=>t("home")});default:return Ot.jsx(n,{})}};return Ot.jsx("div",{className:"min-h-screen bg-gray-50 text-gray-800 font-['Inter']",children:a()})},hC=Jy.createRoot(document.getElementById("root"));hC.render(Ot.jsx(Xy.StrictMode,{children:Ot.jsx(fC,{})}));
