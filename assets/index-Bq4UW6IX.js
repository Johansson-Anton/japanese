 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const pd=(c,t)=>{const n=vn.forwardRef(({className:a,...r},l)=>vn.createElement(iS,{ref:l,iconNode:t,className:K0(`lucide-${$y(ov(c))}`,`lucide-${c}`,a),...r}));return n.displayName=ov(c),n};/**
 * @license lucide-react v0.536.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const aS=[["path",{d:"M12 7v14",key:"1akyts"}],["path",{d:"M3 18a1 1 0 0 1-1-1V4a1 1 0 0 1 1-1h5a4 4 0 0 1 4 4 4 4 0 0 1 4-4h5a1 1 0 0 1 1 1v13a1 1 0 0 1-1 1h-6a3 3 0 0 0-3 3 3 3 0 0 0-3-3z",key:"ruj8y"}]],sS=pd("book-open",aS);/**
 * @license lucide-react v0.536.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const rS=[["path",{d:"m15 18-6-6 6-6",key:"1wnfg3"}]],oS=pd("chevron-left",rS);/**
 * @license lucide-react v0.536.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const lS=[["path",{d:"M12 19v3",key:"npa21l"}],["path",{d:"M19 10v2a7 7 0 0 1-14 0v-2",key:"1vc78b"}],["rect",{x:"9",y:"2",width:"6",height:"13",rx:"3",key:"s6n7sd"}]],cS=pd("mic",lS),tu=({title:c,onGoBack:t})=>Ot.jsxs("div",{className:"flex items-center justify-between p-4 sm:p-6 bg-white border-b-2 border-gray-200 drop-shadow-sm sticky top-0 z-50",children:[Ot.jsx("button",{onClick:t,className:"p-2 rounded-full bg-gray-100 hover:bg-gray-200 transition-colors duration-200","aria-label":"Go back to homepage",children:Ot.jsx(oS,{className:"w-6 h-6 text-gray-700"})}),Ot.jsx("h2",{className:"text-xl sm:text-2xl font-bold text-gray-800 font-['Inter']",children:c}),Ot.jsx("div",{className:"w-8 h-8"})," "]}),uS=["あ","い","う","え","お","か","き","く","け","こ","さ","し","す","せ","そ","た","ち","つ","て","と","な","に","ぬ","ね","の","は","ひ","ふ","へ","ほ","ま","み","む","め","も","や","ゆ","よ","ら","り","る","れ","ろ","わ","を","ん","が","ぎ","ぐ","げ","ご","ざ","じ","ず","ぜ","ぞ","だ","ぢ","づ","で","ど","ば","び","ぶ","べ","ぼ","ぱ","ぴ","ぷ","ぺ","ぽ","ゃ","ゅ","ょ","っ"],fS=["ア","イ","ウ","エ","オ","カ","キ","ク","ケ","コ","サ","シ","ス","セ","ソ","タ","チ","ツ","テ","ト","ナ","ニ","ヌ","ネ","ノ","ハ","ヒ","フ","ヘ","ホ","マ","ミ","ム","メ","モ","ヤ","ユ","ヨ","ラ","リ","ル","レ","ロ","ワ","ヲ","ン","ガ","ギ","グ","ゲ","ゴ","ザ","ジ","ズ","ゼ","ゾ","ダ","ヂ","ヅ","デ","ド","バ","ビ","ブ","ベ","ボ","パ","ピ","プ","ペ","ポ","ャ","ュ","ョ","ッ"],hS=({onGoBack:c})=>Ot.jsxs("div",{className:"flex flex-col items-center p-6 min-h-screen",children:[Ot.jsx(tu,{title:"Hiragana & Katakana",onGoBack:c}),Ot.jsxs("div",{className:"container mx-auto mt-8 flex flex-col lg:flex-row gap-6",children:[Ot.jsxs("div",{className:"bg-white p-6 rounded-2xl border-2 border-purple-200 shadow-lg lg:w-1/2",children:[Ot.jsx("h3",{className:"text-3xl font-extrabold text-purple-600 text-center mb-6",children:"Hiragana"}),Ot.jsx("div",{className:"grid grid-cols-5 md:grid-cols-8 gap-4 text-center",children:uS.map((t,n)=>Ot.jsx("div",{className:"p-3 bg-purple-50 text-purple-800 font-bold text-2xl rounded-lg border border-purple-200 transition-transform transform hover:scale-110",children:t},n))})]}),Ot.jsxs("div",{className:"bg-white p-6 rounded-2xl border-2 border-emerald-200 shadow-lg lg:w-1/2",children:[Ot.jsx("h3",{className:"text-3xl font-extrabold text-emerald-600 text-center mb-6",children:"Katakana"}),Ot.jsx("div",{className:"grid grid-cols-5 md:grid-cols-8 gap-4 text-center",children:fS.map((t,n)=>Ot.jsx("div",{className:"p-3 bg-emerald-50 text-emerald-800 font-bold text-2xl rounded-lg border border-emerald-200 transition-transform transform hover:scale-110",children:t},n))})]})]})]}),dS=({onGoBack:c})=>{const[t,n]=vn.useState(0),[a,r]=vn.useState(!1),l=[{kanji:"日",reading:"に/にち",meaning:"day/sun"},{kanji:"月",reading:"つき",meaning:"moon/month"},{kanji:"火",reading:"ひ",meaning:"fire"},{kanji:"水",reading:"みず",meaning:"water"},{kanji:"木",reading:"き",meaning:"tree/wood"},{kanji:"金",reading:"かね",meaning:"gold/money"},{kanji:"土",reading:"つち",meaning:"earth/soil"}],u=l[t],h=()=>r(!a),d=()=>{r(!1),n((t+1)%l.length)};return Ot.jsxs("div",{className:"flex flex-col items-center justify-center p-6 h-full font-['Inter']",children:[Ot.jsx(tu,{title:"Kanji Flashcards",onGoBack:c}),Ot.jsxs("div",{className:"flex-grow flex flex-col items-center justify-center text-center w-full max-w-2xl",children:[Ot.jsx("div",{className:"relative w-full h-96 sm:h-[30rem] perspective-1000",children:Ot.jsxs("div",{onClick:h,className:`absolute inset-0 w-full h-full transition-transform duration-700 rounded-3xl cursor-pointer shadow-xl
                        ${a?"rotate-y-180":""}`,style:{transformStyle:"preserve-3d"},children:[Ot.jsx("div",{className:"absolute inset-0 flex items-center justify-center bg-blue-100 rounded-3xl backface-hidden",children:Ot.jsx("div",{className:"text-9xl sm:text-[12rem] font-bold text-blue-900 drop-shadow-md",children:u.kanji})}),Ot.jsxs("div",{className:"absolute inset-0 flex flex-col items-center justify-center bg-blue-500 text-white rounded-3xl rotate-y-180 backface-hidden",children:[Ot.jsx("p",{className:"text-3xl sm:text-5xl font-bold mb-4",children:u.reading}),Ot.jsx("p",{className:"text-xl sm:text-2xl",children:u.meaning})]})]})}),Ot.jsx("button",{onClick:d,className:"mt-8 px-8 py-3 bg-blue-600 text-white font-bold rounded-full text-lg shadow-lg hover:bg-blue-700 transition-transform transform hover:scale-105",children:"Next Kanji"})]})]})},pS=({onGoBack:c})=>{const[t,n]=vn.useState(0),[a,r]=vn.useState(0),[l,u]=vn.useState(null),[h,d]=vn.useState(!1),[p,g]=vn.useState(!1),_=[{japanese:"ありがとう",english:"Thank you"},{japanese:"はい",english:"Yes"},{japanese:"いいえ",english:"No"},{japanese:"おはよう",english:"Good morning"},{japanese:"こんにちは",english:"Hello"},{japanese:"おやすみ",english:"Good night"}],v=_[a],S=()=>{const T=[..._],A=v.english;return[...T.filter(P=>P.english!==A).sort(()=>.5-Math.random()).slice(0,3).map(P=>P.english),A].sort(()=>.5-Math.random())},[M,E]=vn.useState(S()),x=T=>{u(T),T===v.english?(d(!0),n(t+1)):g(!0)},y=()=>{d(!1),g(!1),u(null),r((a+1)%_.length),E(S())};return Ot.jsxs("div",{className:"flex flex-col items-center justify-center p-6 h-full font-['Inter']",children:[Ot.jsx(tu,{title:"Vocabulary Quiz",onGoBack:c}),Ot.jsxs("div",{className:"flex-grow flex flex-col items-center justify-center text-center w-full max-w-2xl",children:[Ot.jsx("div",{className:"text-5xl sm:text-7xl font-bold text-blue-800 mb-8",children:v.japanese}),Ot.jsx("div",{className:"grid grid-cols-1 sm:grid-cols-2 gap-4 w-full",children:M.map((T,A)=>Ot.jsx("button",{onClick:()=>x(T),disabled:h||p,className:`p-4 rounded-xl border-2 text-lg sm:text-xl font-medium transition-all duration-300 transform hover:scale-105
...
#endif`,EE="gl_FragColor = linearToOutputTexel( gl_FragColor );",bE=`
...
void main() {
	...
	`}function PT(c){let t=new WeakMap,n=null;function a(h){if(h&&h.isTexture){const d=h.mapping,p=d===od||d===ld,g=d===Br||d===Ir;if(p||g){let _=t.get(h);const v=_!==void 0?_.texture.pmremVersion:0;if(h.isRenderTargetTexture&&h.pmremVersion!==v)return n===null&&(n=new c0(c)),_=p?n.fromEquirectangular(h,_):n.fromCubemap(h,_),_.texture.pmremVersion=h.pmremVersion,t.set(h,_),_.texture;if(_!==void 0)return _.texture;{const S=h.image;return p&&S&&S.height>0||g&&S&&r(S)?(n===null&&(n=new c0(c)),_=p?n.fromEquirectangular(h):n.fromCubemap(h),_.texture.pmremVersion=h.pmremVersion,t.set(h,_),h.addEventListener("dispose",l),_.texture):null}}}return h}function r(h){let d=0;const p=6;for(let g=0;g<p;g++)h[g]!==void 0&&d++;return d===p}function l(h){const d=h.target;d.removeEventListener("dispose",l);const p=t.get(d);p!==void 0&&(t.delete(d),p.dispose())}function u(){t=new WeakMap,n!==null&&(n.dispose(),n=null)}return{get:a,dispose:u}}function zT(c){const t={};function n(a){if(t[a]!==void 0)return t[a];let r;switch(a){case"WEBGL_depth_texture":r=c.getExtension("WEBGL_depth_texture")||c.getExtension("MOZ_WEBGL_depth_texture")||c.getExtension("WEBKIT_WEBGL_depth_texture");break;case"EXT_texture_filter_anisotropic":r=c.getExtension("EXT_texture_filter_anisotropic")||c.getExtension("MOZ_EXT_texture_filter_anisotropic")||c.getExtension("WEBKIT_EXT_texture_filter_anisotropic");break;case"WEBGL_compressed_texture_s3tc":r=c.getExtension("WEBGL_compressed_texture_s3tc")||c.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||c.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");break;case"WEBGL_compressed_texture_pvrtc":r=c.getExtension("WEBGL_compressed_texture_pvrtc")||c.getExtension("WEBKIT_WEBGL_compressed_texture_pvrtc");break;default:r=c.getExtension(a)}return t[a]=r,r}return{has:function(a){return n(a)!==null},init:function(){n("EXT_color_buffer_float"),n("WEBGL_clip_cull_distance"),n("OES_texture_float_linear"),n("EXT_color_buffer_half_float"),n("WEBGL_multisampled_render_to_texture"),n("WEBGL_render_shared_exponent")},get:function(a){const r=n(a);return r===null&&u_("THREE.WebGLRenderer: "+a+" extension not supported."),r}}}function BT(c,t,n,a){const r={},l=new WeakMap;function u(_){const v=_.target;v.index!==null&&t.remove(v.index);for(const M in v.attributes)t.remove(v.attributes[M]);for(const M in v.morphAttributes){const E=v.morphAttributes[M];for(let x=0,y=E.length;x<y;x++)t.remove(E[x])}v.removeEventListener("dispose",u),delete r[v.id];const S=l.get(v);S&&(t.remove(S),l.delete(v)),a.releaseStatesOfGeometry(v),v.isInstancedBufferGeometry===!0&&delete v._maxInstanceCount,n.memory.geometries--}function h(_,v){return r[v.id]===!0||(v.addEventListener("dispose",u),r[v.id]=!0,n.memory.geometries++),v}function d(_){const v=_.attributes;for(const M in v)t.update(v[M],c.ARRAY_BUFFER);const S=_.morphAttributes;for(const M in S){const E=S[M];for(let x=0,y=E.length;x<y;x++)t.update(E[x],c.ARRAY_BUFFER)}}function p(_){const v=[],S=_.index,M=_.attributes.position;let E=0;if(S!==null){const T=S.array;E=S.version;for(let A=0,D=T.length;A<D;A+=3){const I=T[A+0],P=T[A+1],z=T[A+2];v.push(I,P,P,z,z,I)}}else if(M!==void 0){const T=M.array;E=M.version;for(let A=0,D=T.length/3-1;A<D;A+=3){const I=A+0,P=A+1,z=A+2;v.push(I,P,P,z,z,I)}}else return;const x=new(c_(v)?v_:g_)(v,1);x.version=E;const y=l.get(_);y&&t.remove(y),l.set(_,x)}function g(_){const v=l.get(_);if(v){const S=_.index;S!==null&&v.version<S.version&&p(_)}else p(_);return l.get(_)}return{get:h,update:d,getWireframeAttribute:g}}function IT(c,t,n){let a;function r(v){a=v}let l,u;function h(v){l=v.type,u=v.bytesPerElement}function d(v,S){c.drawElements(a,S,l,v*u),n.update(S,a,1)}function p(v,S,M){M!==0&&(c.drawElementsInstanced(a,S,l,v*u,M),n.update(S,a,M))}function g(v,S,M){if(M===0)return;const E=t.get("WEBGL_multi_draw");if(E===null)for(let x=0;x<M;x++)this.render(v[x]/u,S[x]);else{E.multiDrawElementsWEBGL(a,S,0,l,v,0,M);let x=0;for(let y=0;y<M;y++)x+=S[y];n.update(x,a,1)}}function _(v,S,M,E){if(M===0)return;const x=t.get("WEBGL_multi_draw");if(x===null)for(let y=0;y<v.length;y++)p(v[y]/u,S[y],E[y]);else{x.multiDrawElementsInstancedWEBGL(a,S,0,l,v,0,E,0,M);let y=0;for(let T=0;T<M;T++)y+=S[T];for(let T=0;T<E.length;T++)n.update(y,a,E[T])}}this.setMode=r,this.setIndex=h,this.render=d,this.renderInstances=p,this.renderMultiDraw=g,this.renderMultiDrawInstances=_}function FT(c){const t={geometries:0,textures:0},n={frame:0,calls:0,triangles:0,points:0,lines:0};function a(l,u,h){switch(n.calls++,u){case c.TRIANGLES:n.triangles+=h*(l/3);break;case c.LINES:n.lines+=h*(l/2);break;case c.LINE_STRIP:n.lines+=h*(l-1);break;case c.LINE_LOOP:n.lines+=h*l;break;case c.POINTS:n.points+=h*l;break;default:console.error("THREE.WebGLInfo: Unknown draw mode:",u);break}}function r(){n.calls=0,n.triangles=0,n.points=0,n.lines=0}return{memory:t,render:n,programs:null,autoReset:!0,reset:r,update:a}}function HT(c,t,n){const a=new WeakMap,r=new _n;function l(u,h,d){const p=u.morphTargetInfluences,g=h.morphAttributes.position||h.morphAttributes.normal||h.morphAttributes.color,_=g!==void 0?g.length:0;let v=a.get(h);if(v===void 0||v.count!==_){let w=function(){k.dispose(),a.delete(h),h.removeEventListener("dispose",w)};var S=w;v!==void 0&&v.texture.dispose();const M=h.morphAttributes.position!==void 0,E=h.morphAttributes.normal!==void 0,x=h.morphAttributes.color!==void 0,y=h.morphAttributes.position||[],T=h.morphAttributes.normal||[],A=h.morphAttributes.color||[];let D=0;M===!0&&(D=1),E===!0&&(D=2),x===!0&&(D=3);let I=h.attributes.position.count*D,P=1;I>t.maxTextureSize&&(P=Math.ceil(I/t.maxTextureSize),I=t.maxTextureSize);const z=new Float32Array(I*P*4*_),k=new h_(z,I,P,_);k.type=Za,k.needsUpdate=!0;const N=D*4;for(let F=0;F<_;F++){const it=y[F],V=T[F],Q=A[F],j=I*P*4*F;for(let L=0;L<it.count;L++){const Z=L*N;M===!0&&(r.fromBufferAttribute(it,L),z[j+Z+0]=r.x,z[j+Z+1]=r.y,z[j+Z+2]=r.z,z[j+Z+3]=0),E===!0&&(r.fromBufferAttribute(V,L),z[j+Z+4]=r.x,z[j+Z+5]=r.y,z[j+Z+6]=r.z,z[j+Z+7]=0),x===!0&&(r.fromBufferAttribute(Q,L),z[j+Z+8]=r.x,z[j+Z+9]=r.y,z[j+Z+10]=r.z,z[j+Z+11]=Q.itemSize===4?r.w:1)}}v={count:_,texture:k,size:new Me(I,P)},a.set(h,v),h.addEventListener("dispose",w)}if(u.isInstancedMesh===!0&&u.morphTexture!==null)d.getUniforms().setValue(c,"morphTexture",u.morphTexture,n);else{let M=0;for(let x=0;x<p.length;x++)M+=p[x];const E=h.morphTargetsRelative?1:1-M;d.getUniforms().setValue(c,"morphTargetBaseInfluence",E),d.getUniforms().setValue(c,"morphTargetInfluences",p)}d.getUniforms().setValue(c,"morphTargetsTexture",v.texture,n),d.getUniforms().setValue(c,"morphTargetsTextureSize",v.size)}return{update:l}}function GT(c,t,n,a){let r=new WeakMap;function l(d){const p=a.render.frame,g=d.geometry,_=t.get(d,g);if(r.get(_)!==p&&(t.update(_),r.set(_,p)),d.isInstancedMesh&&(d.hasEventListener("dispose",h)===!1&&d.addEventListener("dispose",h),r.get(d)!==p&&(n.update(d.instanceMatrix,c.ARRAY_BUFFER),d.instanceColor!==null&&n.update(d.instanceColor,c.ARRAY_BUFFER),r.set(d,p))),d.isSkinnedMesh){const v=d.skeleton;r.get(v)!==p&&(v.update(),r.set(v,p))}return _}function u(){r=new WeakMap}function h(d){const p=d.target;p.removeEventListener("dispose",h),n.remove(p.instanceMatrix),p.instanceColor!==null&&n.remove(p.instanceColor)}return{update:l,dispose:u}}class E_ extends kn{constructor(t,n,a,r,l,u,h,d,p,g=Pr){if(g!==Pr&&g!==Gr)throw new Error("DepthTexture format must be either THREE.DepthFormat or THREE.DepthStencilFormat");a===void 0&&g===Pr&&(a=Fr),a===void 0&&g===Gr&&(a=Hr),super(null,r,l,u,h,d,g,a,p),this.isDepthTexture=!0,this.image={width:t,height:n},this.magFilter=h!==void 0?h:hi,this.minFilter=d!==void 0?d:hi,this.flipY=!1,this.generateMipmaps=!1,this.compareFunction=null}copy(t){return super.copy(t),this.compareFunction=t.compareFunction,this}toJSON(t){const n=super.toJSON(t);return this.compareFunction!==null&&(n.compareFunction=this.compareFunction),n}}const b_=new kn,T_=new E_(1,1);T_.compareFunction=l_;const A_=new h_,w_=new AM,R_=new y_,d0=[],p0=[],m0=new Float32Array(16),g0=new Float32Array(9),v0=new Float32Array(4);function Xr(c,t,n){const a=c[0];if(a<=0||a>0)return c;const r=t*n;let l=d0[r];if(l===void 0&&(l=new Float32Array(r),d0[r]=l),t!==0){a.toArray(l,0);for(let u=1,h=0;u!==t;++u)h+=n,c[u].toArray(l,h)}return l}function fn(c,t){if(c.length!==t.length)return!1;for(let n=0,a=c.length;n<a;n++)if(c[n]!==t[n])return!1;return!0}function hn(c,t){for(let n=0,a=t.length;n<a;n++)c[n]=t[n]}function su(c,t){let n=p0[t];n===void 0&&(n=new Int32Array(t),p0[t]=n);for(let a=0;a!==t;++a)n[a]=c.allocateTextureUnit();return n}function VT(c,t){const n=this.cache;n[0]!==t&&(c.uniform1f(this.addr,t),n[0]=t)}function kT(c,t){const n=this.cache;if(t.x!==void 0)(n[0]!==t.x||n[1]!==t.y)&&(c.uniform2f(this.addr,t.x,t.y),n[0]=t.x,n[1]=t.y);else{if(fn(n,t))return;c.uniform2fv(this.addr,t),hn(n,t)}}function qT(c,t){const n=this.cache;if(t.x!==void 0)(n[0]!==t.x||n[1]!==t.y||n[2]!==t.z)&&(c.uniform3f(this.addr,t.x,t.y,t.z),n[0]=t.x,n[1]=t.y,n[2]=t.z);else if(t.r!==void 0)(n[0]!==t.r||n[1]!==t.g||n[2]!==t.b)&&(c.uniform3f(this.addr,t.r,t.g,t.b),n[0]=t.r,n[1]=t.g,n[2]=t.b);else{if(fn(n,t))return;c.uniform3fv(this.addr,t),hn(n,t)}}function XT(c,t){const n=this.cache;if(t.x!==void 0)(n[0]!==t.x||n[1]!==t.y||n[2]!==t.z||n[3]!==t.w)&&(c.uniform4f(this.addr,t.x,t.y,t.z,t.w),n[0]=t.x,n[1]=t.y,n[2]=t.z,n[3]=t.w);else{if(fn(n,t))return;c.uniform4fv(this.addr,t),hn(n,t)}}function WT(c,t){const n=this.cache,a=t.elements;if(a===void 0){if(fn(n,t))return;c.uniformMatrix2fv(this.addr,!1,t),hn(n,t)}else{if(fn(n,a))return;v0.set(a),c.uniformMatrix2fv(this.addr,!1,v0),hn(n,a)}}function YT(c,t){const n=this.cache,a=t.elements;if(a===void 0){if(fn(n,t))return;c.uniformMatrix3fv(this.addr,!1,t),hn(n,t)}else{if(fn(n,a))return;g0.set(a),c.uniformMatrix3fv(this.addr,!1,g0),hn(n,a)}}function jT(c,t){const n=this.cache,a=t.elements;if(a===void 0){if(fn(n,t))return;c.uniformMatrix4fv(this.addr,!1,t),hn(n,t)}else{if(fn(n,a))return;m0.set(a),c.uniformMatrix4fv(this.addr,!1,m0),hn(n,a)}}function ZT(c,t){const n=this.cache;n[0]!==t&&(c.uniform1i(this.addr,t),n[0]=t)}function KT(c,t){const n=this.cache;if(t.x!==void 0)(n[0]!==t.x||n[1]!==t.y)&&(c.uniform2i(this.addr,t.x,t.y),n[0]=t.x,n[1]=t.y);else{if(fn(n,t))return;c.uniform2iv(this.addr,t),hn(n,t)}}function QT(c,t){const n=this.cache;if(t.x!==void 0)(n[0]!==t.x||n[1]!==t.y||n[2]!==t.z)&&(c.uniform3i(this.addr,t.x,t.y,t.z),n[0]=t.x,n[1]=t.y,n[2]=t.z);else{if(fn(n,t))return;c.uniform3iv(this.addr,t),hn(n,t)}}function JT(c,t){const n=this.cache;if(t.x!==void 0)(n[0]!==t.x||n[1]!==t.y||n[2]!==t.z||n[3]!==t.w)&&(c.uniform4i(this.addr,t.x,t.y,t.z,t.w),n[0]=t.x,n[1]=t.y,n[2]=t.z,n[3]=t.w);else{if(fn(n,t))return;c.uniform4iv(this.addr,t),hn(n,t)}}function $T(c,t){const n=this.cache;n[0]!==t&&(c.uniform1ui(this.addr,t),n[0]=t)}function tA(c,t){const n=this.cache;if(t.x!==void 0)(n[0]!==t.x||n[1]!==t.y)&&(c.uniform2ui(this.addr,t.x,t.y),n[0]=t.x,n[1]=t.y);else{if(fn(n,t))return;c.uniform2uiv(this.addr,t),hn(n,t)}}function eA(c,t){const n=this.cache;if(t.x!==void 0)(n[0]!==t.x||n[1]!==t.y||n[2]!==t.z)&&(c.uniform3ui(this.addr,t.x,t.y,t.z),n[0]=t.x,n[1]=t.y,n[2]=t.z);else{if(fn(n,t))return;c.uniform3uiv(this.addr,t),hn(n,t)}}function nA(c,t){const n=this.cache;if(t.x!==void 0)(n[0]!==t.x||n[1]!==t.y||n[2]!==t.z||n[3]!==t.w)&&(c.uniform4ui(this.addr,t.x,t.y,t.z,t.w),n[0]=t.x,n[1]=t.y,n[2]=t.z,n[3]=t.w);else{if(fn(n,t))return;c.uniform4uiv(this.addr,t),hn(n,t)}}function iA(c,t,n){const a=this.cache,r=n.allocateTextureUnit();a[0]!==r&&(c.uniform1i(this.addr,r),a[0]=r);const l=this.type===c.SAMPLER_2D_SHADOW?T_:b_;n.setTexture2D(t||l,r)}function aA(c,t,n){const a=this.cache,r=n.allocateTextureUnit();a[0]!==r&&(c.uniform1i(this.addr,r),a[0]=r),n.setTexture3D(t||w_,r)}function sA(c,t,n){const a=this.cache,r=n.allocateTextureUnit();a[0]!==r&&(c.uniform1i(this.addr,r),a[0]=r),n.setTextureCube(t||R_,r)}function rA(c,t,n){const a=this.cache,r=n.allocateTextureUnit();a[0]!==r&&(c.uniform1i(this.addr,r),a[0]=r),n.setTexture2DArray(t||A_,r)}function oA(c){switch(c){case 5126:return VT;case 35664:return kT;case 35665:return qT;case 35666:return XT;case 35674:return WT;case 35675:return YT;case 35676:return jT;case 5124:case 35670:return ZT;case 35667:case 35671:return KT;case 35668:case 35672:return QT;case 35669:case 35673:return JT;case 5125:return $T;case 36294:return tA;case 36295:return eA;case 36296:return nA;case 35678:case 36198:case 36298:case 36306:case 35682:return iA;case 35679:case 36299:case 36307:return aA;case 35680:case 36300:case 36308:case 36293:return sA;case 36289:case 36303:case 36311:case 36292:return rA}}function lA(c,t){c.uniform1fv(this.addr,t)}function cA(c,t){const n=Xr(t,this.size,2);c.uniform2fv(this.addr,n)}function uA(c,t){const n=Xr(t,this.size,3);c.uniform3fv(this.addr,n)}function fA(c,t){const n=Xr(t,this.size,4);c.uniform4fv(this.addr,n)}function hA(c,t){const n=Xr(t,this.size,4);c.uniformMatrix2fv(this.addr,!1,n)}function dA(c,t){const n=Xr(t,this.size,9);c.uniformMatrix3fv(this.addr,!1,n)}function pA(c,t){const n=Xr(t,this.size,16);c.uniformMatrix4fv(this.addr,!1,n)}function mA(c,t){c.uniform1iv(this.addr,t)}function gA(c,t){c.uniform2iv(this.addr,t)}function vA(c,t){c.uniform3iv(this.addr,t)}function _A(c,t){c.uniform4iv(this.addr,t)}function xA(c,t){c.uniform1uiv(this.addr,t)}function yA(c,t){c.uniform2uiv(this.addr,t)}function SA(c,t){c.uniform3uiv(this.addr,t)}function MA(c,t){c.uniform4uiv(this.addr,t)}function EA(c,t,n){const a=this.cache,r=t.length,l=su(n,r);fn(a,l)||(c.uniform1iv(this.addr,l),hn(a,l));for(let u=0;u!==r;++u)n.setTexture2D(t[u]||b_,l[u])}function bA(c,t,n){const a=this.cache,r=t.length,l=su(n,r);fn(a,l)||(c.uniform1iv(this.addr,l),hn(a,l));for(let u=0;u!==r;++u)n.setTexture3D(t[u]||w_,l[u])}function TA(c,t,n){const a=this.cache,r=t.length,l=su(n,r);fn(a,l)||(c.uniform1iv(this.addr,l),hn(a,l));for(let u=0;u!==r;++u)n.setTextureCube(t[u]||R_,l[u])}function AA(c,t,n){const a=this.cache,r=t.length,l=su(n,r);fn(a,l)||(c.uniform1iv(this.addr,l),hn(a,l));for(let u=0;u!==r;++u)n.setTexture2DArray(t[u]||A_,l[u])}function wA(c){switch(c){case 5126:return lA;case 35664:return cA;case 35665:return uA;case 35666:return fA;case 35674:return hA;case 35675:return dA;case 35676:return pA;case 5124:case 35670:return mA;case 35667:case 35671:return gA;case 35668:case 35672:return vA;case 35669:case 35673:return _A;case 5125:return xA;case 36294:return yA;case 36295:return SA;case 36296:return MA;case 35678:case 36198:case 36298:case 36306:case 35682:return EA;case 35679:case 36299:case 36307:return bA;case 35680:case 36300:case 36308:case 36293:return TA;case 36289:case 36303:case 36311:case 36292:return AA}}class RA{constructor(t,n,a){this.id=t,this.addr=a,this.cache=[],this.type=n.type,this.setValue=oA(n.type)}}class CA{constructor(t,n,a){this.id=t,this.addr=a,this.cache=[],this.type=n.type,this.size=n.size,this.setValue=wA(n.type)}}class DA{constructor(t){this.id=t,this.seq=[],this.map={}}setValue(t,n,a){const r=this.seq;for(let l=0,u=r.length;l!==u;++l){const h=r[l];h.setValue(t,n[h.id],a)}}}const Zh=/(\w+)(\])?(\[|\.)?/g;function _0(c,t){c.seq.push(t),c.map[t.id]=t}function UA(c,t,n){const a=c.name,r=a.length;for(Zh.lastIndex=0;;){const l=Zh.exec(a),u=Zh.lastIndex;let h=l[1];const d=l[2]==="]",p=l[3];if(d&&(h=h|0),p===void 0||p==="["&&u+2===r){_0(n,p===void 0?new RA(h,c,t):new CA(h,c,t));break}else{let _=n.map[h];_===void 0&&(_=new DA(h),_0(n,_)),n=_}}}class qc{constructor(t,n){this.seq=[],this.map={};const a=t.getProgramParameter(n,t.ACTIVE_UNIFORMS);for(let r=0;r<a;++r){const l=t.getActiveUniform(n,r),u=t.getUniformLocation(n,l.name);UA(l,u,this)}}setValue(t,n,a,r){const l=this.map[n];l!==void 0&&l.setValue(t,a,r)}setOptional(t,n,a){const r=n[a];r!==void 0&&this.setValue(t,a,r)}static upload(t,n,a,r){for(let l=0,u=n.length;l!==u;++l){const h=n[l],d=a[h.id];d.needsUpdate!==!1&&h.setValue(t,d.value,r)}}static seqWithValue(t,n){const a=[];for(let r=0,l=t.length;r!==l;++r){const u=t[r];u.id in n&&a.push(u)}return a}}function x0(c,t,n){const a=c.createShader(t);return c.shaderSource(a,n),c.compileShader(a),a}const NA=37297;let LA=0;function OA(c,t){const n=c.split(`
`),a=[],r=Math.max(t-6,0),l=Math.min(t+6,n.length);for(let u=r;u<l;u++){const h=u+1;a.push(`${h===t?">":" "} ${h}: ${n[u]}`)}return a.join(`
`)}function PA(c){const t=Ne.getPrimaries(Ne.workingColorSpace),n=Ne.getPrimaries(c);let a;switch(t===n?a="":t===Zc&&n===jc?a="LinearDisplayP3ToLinearSRGB":t===jc&&n===Zc&&(a="LinearSRGBToLinearDisplayP3"),c){case es:case iu:return[a,"LinearTransferOETF"];case Li:case gd:return[a,"sRGBTransferOETF"];default:return console.warn("THREE.WebGLProgram: Unsupported color space:",c),[a,"LinearTransferOETF"]}}function y0(c,t,n){const a=c.getShaderParameter(t,c.COMPILE_STATUS),r=c.getShaderInfoLog(t).trim();if(a&&r==="")return"";const l=/ERROR: 0:(\d+)/.exec(r);if(l){const u=parseInt(l[1]);return n.toUpperCase()+`

`+r+`

`+OA(c.getShaderSource(t),u)}else return r}function zA(c,t){const n=PA(t);return`vec4 ${c}( vec4 value ) { return ${n[0]}( ${n[1]}( value ) ); }`}function BA(c,t){let n;switch(t){case qS:n="Linear";break;case XS:n="Reinhard";break;case WS:n="OptimizedCineon";break;case YS:n="ACESFilmic";break;case ZS:n="AgX";break;case KS:n="Neutral";break;case jS:n="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",t),n="Linear"}return"vec3 "+c+"( vec3 color ) { return "+n+"ToneMapping( color ); }"}function IA(c){return[c.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",c.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(el).join(`
`)}function FA(c){const t=[];for(const n in c){const a=c[n];a!==!1&&t.push("#define "+n+" "+a)}return t.join(`
`)}function HA(c,t){const n={},a=c.getProgramParameter(t,c.ACTIVE_ATTRIBUTES);for(let r=0;r<a;r++){const l=c.getActiveAttrib(t,r),u=l.name;let h=1;l.type===c.FLOAT_MAT2&&(h=2),l.type===c.FLOAT_MAT3&&(h=3),l.type===c.FLOAT_MAT4&&(h=4),n[u]={type:l.type,location:c.getAttribLocation(t,u),locationSize:h}}return n}function el(c){return c!==""}function S0(c,t){const n=t.numSpotLightShadows+t.numSpotLightMaps-t.numSpotLightShadowsWithMaps;return c.replace(/NUM_DIR_LIGHTS/g,t.numDirLights).replace(/NUM_SPOT_LIGHTS/g,t.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,t.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,n).replace(/NUM_RECT_AREA_LIGHTS/g,t.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,t.numPointLights).replace(/NUM_HEMI_LIGHTS/g,t.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,t.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,t.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,t.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,t.numPointLightShadows)}function M0(c,t){return c.replace(/NUM_CLIPPING_PLANES/g,t.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,t.numClippingPlanes-t.numClipIntersection)}const GA=/^[ \t]*#include +<([\w\d./]+)>/gm;function hd(c){return c.replace(GA,kA)}const VA=new Map;function kA(c,t){let n=oe[t];if(n===void 0){const a=VA.get(t);if(a!==void 0)n=oe[a],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',t,a);else throw new Error("Can not resolve #include <"+t+">")}return hd(n)}const qA=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function E0(c){return c.replace(qA,XA)}function XA(c,t,n,a){let r="";for(let l=parseInt(t);l<parseInt(n);l++)r+=a.replace(/\[\s*i\s*\]/g,"[ "+l+" ]").replace(/UNROLLED_LOOP_INDEX/g,l);return r}function b0(c){let t=`precision ${c.precision} float;
...
#define LOW_PRECISION`),t}function WA(c){let t="SHADOWMAP_TYPE_BASIC";return c.shadowMapType===Q0?t="SHADOWMAP_TYPE_PCF":c.shadowMapType===J0?t="SHADOWMAP_TYPE_PCF_SOFT":c.shadowMapType===fa&&(t="SHADOWMAP_TYPE_VSM"),t}function YA(c){let t="ENVMAP_TYPE_CUBE";if(c.envMap)switch(c.envMapMode){case Br:case Ir:t="ENVMAP_TYPE_CUBE";break;case eu:t="ENVMAP_TYPE_CUBE_UV";break}return t}function jA(c){let t="ENVMAP_MODE_REFLECTION";if(c.envMap)switch(c.envMapMode){case Ir:t="ENVMAP_MODE_REFRACTION";break}return t}function ZA(c){let t="ENVMAP_BLENDING_NONE";if(c.envMap)switch(c.combine){case $0:t="ENVMAP_BLENDING_MULTIPLY";break;case VS:t="ENVMAP_BLENDING_MIX";break;case kS:t="ENVMAP_BLENDING_ADD";break}return t}function KA(c){const t=c.envMapCubeUVHeight;if(t===null)return null;const n=Math.log2(t)-2,a=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,n),112)),texelHeight:a,maxMip:n}}function QA(c,t,n,a){const r=c.getContext(),l=n.defines;let u=n.vertexShader,h=n.fragmentShader;const d=WA(n),p=YA(n),g=jA(n),_=ZA(n),v=KA(n),S=IA(n),M=FA(l),E=r.createProgram();let x,y,T=n.glslVersion?"#version "+n.glslVersion+`
