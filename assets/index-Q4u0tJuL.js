 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const rS=vn.forwardRef(({color:c="currentColor",size:t=24,strokeWidth:n=2,absoluteStrokeWidth:a,className:r="",children:l,iconNode:u,...h},d)=>vn.createElement("svg",{ref:d,...sS,width:t,height:t,stroke:c,strokeWidth:a?Number(n)*24/Number(t):n,className:$0("lucide",r),...!l&&!aS(h)&&{"aria-hidden":"true"},...h},[...u.map(([p,g])=>vn.createElement(p,g)),...Array.isArray(l)?l:[l]]));/**
 * @license lucide-react v0.536.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const md=(c,t)=>{const n=vn.forwardRef(({className:a,...r},l)=>vn.createElement(rS,{ref:l,iconNode:t,className:$0(`lucide-${nS(lv(c))}`,`lucide-${c}`,a),...r}));return n.displayName=lv(c),n};/**
 * @license lucide-react v0.536.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
